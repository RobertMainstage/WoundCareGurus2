...
//Changed 'Instructor' from 'Teacher.' Changed 'Attendee' from 'Student'
?>
<div class="course-info">
	<ul class="list-inline clearfix">
		<li class="list-inline-item item-author">
			<div class="author" itemprop="creator">
				...
				<div class="info">
					...
					<label><?php esc_html_e( 'Instructor', 'course-builder' ); ?></label>
		...
		<li class="list-inline-item item-students">
			<label><?php esc_html_e( 'Attendees', 'course-builder' ); ?></label>
