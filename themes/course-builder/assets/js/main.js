...
!(function (e, t) {
    ...
    (e.Controller = function (n) {
      var i,
        ...
        w = function () {
          ...
          (p =
            ...
            p && (u.container = window),
            (v = u.vertical
              ? r.get.height(u.container)
              : r.get.width(u.container)),
            u.container.addEventListener("resize", x),
            u.container.addEventListener("scroll", x),
            (u.refreshInterval =
              parseInt(u.refreshInterval) || l.refreshInterval),
            y();
        },
        y = function () {
          u.refreshInterval > 0 &&
            (o = window.setTimeout(z, u.refreshInterval));
        },
        E = function () {
          return u.vertical
            ? r.get.scrollTop(u.container)
            : r.get.scrollLeft(u.container);
        },
        S = function (e) {
          u.vertical
            ? p
      ...
      return (
        (this.addScene = function (t) {
          if (r.type.Array(t))
            ...
            if (t.controller() !== c) t.addTo(c);
              ...
              for (var n in u.globalSceneOptions)
        ...
        (this.destroy = function (e) {
          ...
          return (
            u.container.removeEventListener("resize", x),
    ...
    (e.Scene = function (t) {
      ...
      (this.addTo = function (t) {
        return (
          t instanceof e.Controller &&
            ...
            w(!0),
            v(),
            o.info("container").addEventListener("resize", y),
            t.addScene(l),
        ...
        (this.destroy = function (e) {
          return (
            l.trigger("destroy", { reset: e }), l.remove(), l.off("*.*"), null
          );
        }),
        (this.update = function (e) {
          if (o)
        ...
        (this.progress = function (e) {
          if (arguments.length) {
            ...
            if (
              ...
              var s = { progress: f, state: u, scrollDirection: r },
                a = u != n,
                d = function (e) {
                  l.trigger(e, s);
                };
              a &&
                "DURING" !== n &&
                (d("enter"), d("BEFORE" === n ? "start" : "end")),
                d("progress"),
                a &&
                  "DURING" !== u &&
                  (d("BEFORE" === u ? "start" : "end"), d("leave"));
            }
            return l;
          }
          return f;
      ...
      var v = function () {
          (d = { start: g + c.offset }),
            o &&
              c.triggerElement &&
              (d.start -= o.info("size") * c.triggerHook),
        ...
        m = function (e) {
          if (i) {
            ...
            b(t, i.call(l)) &&
              !e &&
              (l.trigger("change", { what: t, newval: c[t] }),
              l.trigger("shift", { reason: t }));
          }
        },
        w = function (e) {
          var t = 0,
          ...
          if (o && n) {
            for (
              var i = o.info(),
                a = r.get.offset(i.container),
                u = i.vertical ? "top" : "left";
              n.parentNode.hasAttribute(s);
          ...
          var d = t != g;
          (g = t),
            d && !e && l.trigger("shift", { reason: "triggerElementPosition" });
        },
        y = function () {
          c.triggerHook > 0 &&
        ...
        E = r.extend(n.validate, {
          duration: function (e) {
            ...
            if (((e = parseFloat(e)), !r.type.Number(e) || 0 > e))
              throw i ? ((i = void 0), 0) : 0;
            return e;
          },
        }),
        S = function (e) {
          ...
          l[e] ||
            (l[e] = function (t) {
              return arguments.length
                ? ("duration" === e && (i = void 0),
                  b(e, t) &&
                    (l.trigger("change", { what: e, newval: c[e] }),
      ...
      (this.controller = function () {
        ...
        (this.triggerPosition = function () {
          var e = c.offset;
          return (
            o && (e += c.triggerElement ? g : o.info("size") * l.triggerHook()),
            e
          );
        });
      var x = {};
        ...
        return (
          r.type.Function(t) &&
            ...
            e.forEach(function (e) {
              ...
              "*" != r &&
                (x[r] || (x[r] = []),
                x[r].push({ namespace: i || "", callback: t }));
            })),
          l
        );
      }),
          ...
          if (t) {
            ...
            s &&
              s.forEach(function (t) {
                (o && o !== t.namespace) ||
                  t.callback.call(l, new e.Event(i, t.namespace, l, n));
              });
          }
          return l;
        });
      ...
      l.on("shift.internal", function (e) {
        ...
        (("AFTER" === u && t) || ("DURING" === u && 0 === c.duration)) && R(),
          t && C();
      })
      ...
      var R = function (e) {
          if (z && o) {
            ...
            if (e || "DURING" !== u) {
              ...
              T.pushFollowers
                ? c.duration > 0 &&
                  ("AFTER" === u &&
                  0 === parseFloat(r.css(T.spacer, "padding-top"))
                    ? (i = !0)
                    : "BEFORE" === u &&
              ...
              "fixed" != r.css(z, "position") &&
                (r.css(z, { position: "fixed" }), C());
              var s = r.get.offset(T.spacer, !0),
                a =
                  c.reverse || 0 === c.duration
                    ? t.scrollPos - d.start
                    : Math.round(f * c.duration * 10) / 10;
              (s[t.vertical ? "top" : "left"] += a),
                r.css(z, { top: s.top, left: s.left });
            }
          }
        },
        C = function () {
          if (z && o && T.inFlow) {
            ...
            T.relSize.width || T.relSize.autoFullWidth
              ? e
                ? r.css(z, { width: r.get.width(T.spacer) })
                : r.css(z, { width: "100%" })
              : ((s["min-width"] = r.get.width(t ? z : n, !0, !0)),
                (s.width = e ? s["min-width"] : "auto")),
              T.relSize.height
                ? e
                  ? r.css(z, { height: r.get.height(T.spacer) - c.duration })
                  : r.css(z, { height: "100%" })
                : ((s["min-height"] = r.get.height(t ? n : z, !0, !i)),
                  (s.height = e ? s["min-height"] : "auto")),
              T.pushFollowers &&
                ((s["padding" + (t ? "Top" : "Left")] = c.duration * f),
        ...
        N = function (e) {
          o &&
            ...
            o.scrollTo(
              o.info("scrollPos") -
                (e[o.info("vertical") ? "wheelDeltaY" : "wheelDeltaX"] / 3 ||
                  30 * -e.detail)
            ));
        };
      (this.setPin = function (e, t) {
        var n = { pushFollowers: !0, spacerClass: "scrollmagic-pin-spacer" };
        if (((t = r.extend({}, n, t)), (e = r.get.elements(e)[0]), !e))
          return l;
        ...
        (z.parentNode.style.display = i),
          !a && t.pushFollowers && (t.pushFollowers = !1);
        ...
        if (
          (a || r.extend(d, r.css(z, ["width", "height"])),
          r.css(f, d),
          f.setAttribute(s, ""),
          r.addClass(f, t.spacerClass),
          (T = {
            spacer: f,
            relSize: {
              ...
              autoFullWidth:
                "auto" === u.width && a && r.isMarginCollapseType(c.display),
            },
        ...
        return (
          T.relSize.width && r.css(f, { width: u.width }),
          T.relSize.height && r.css(f, { height: u.height }),
          f.appendChild(z),
          r.css(z, {
            position: a ? "relative" : "absolute",
            margin: "auto",
          ...
          z.addEventListener("mousewheel", N),
          z.addEventListener("DOMMouseScroll", N),
          R(),
          l
        );
      }),
        (this.removePin = function (e) {
          if (z) {
            if (("DURING" === u && R(!0), e || !o)) {
              ...
              T.spacer.parentNode.insertBefore(t, T.spacer),
                T.spacer.parentNode.removeChild(T.spacer),
                z.parentNode.hasAttribute(s) ||
                  (r.css(z, z.___origStyle), delete z.___origStyle);
            }
            window.removeEventListener("scroll", L),
              window.removeEventListener("resize", L),
              window.removeEventListener("resize", D),
              z.removeEventListener("mousewheel", N),
              z.removeEventListener("DOMMouseScroll", N),
              (z = void 0);
          }
          return l;
        });
      ...
      return (
        ...
        (this.setClassToggle = function (e, t) {
          ...
          return 0 !== n.length && r.type.String(t)
            ? (A.length > 0 && l.removeClassToggle(),
              (O = t),
              (A = n),
  ...
  (e.Scene.addOption = function (e, t, r, i) {
    e in n.defaults ||
      ((n.defaults[e] = t), (n.validate[e] = r), i && n.shifts.push(e));
  }),
...
(function ($) {
  ...
  var thim_course_builder = (window.thim_course_builder = {
    ...
    validate_login_form: function () {
      $(".thim-login form").each(function () {
        $(this).submit(function (event) {
          var elem = $(this),
            ...
            input_checkbox = elem.find('input[name="term"]'),
          ...
          // if (input_checkbox.length > 0 && input_checkbox.val() === '') {
          if (
            input_checkbox.is(":checkbox") &&
            !input_checkbox.is(":checked")
          ) {
            input_checkbox.addClass("invalid");
            event.preventDefault();
          }
      ...
      $(".thim-login input.required").on("focus", function () {
    ...
    thim_course_searching: function () {
      ...
      $(document).on(
        ...
        function (event) {
          ...
          if (
            ...
            var elem = $(this),
              keyword =
                event.keyCode === 8 ? elem.val() : elem.val() + event.key,
              $body = $("body");
            ...
            search_time_out = setTimeout(function () {
              ...
              $(".archive-courses").addClass("loading");
    ...
    header_menu_mobile: function () {
      ...
      $(
        ".main-menu li.menu-item-has-children > a,.main-menu li.menu-item-has-children > span, .main-menu li.tc-menu-layout-builder > a,.main-menu li.tc-menu-layout-builder > span"
      ).after(
        '<span class="icon-toggle"><i class="fa fa-caret-down"></i></span>'
      );

      $(
        ".responsive .mobile-menu-container .navbar-nav > li.menu-item-has-children > a, .responsive .mobile-menu-container .navbar-nav > li.tc-menu-layout-builder:not(.current-menu-parent) > a"
      ).after(
        '<span class="icon-toggle"><i class="fa fa-caret-down"></i></span>'
      );
      ...
      $(
        ".responsive .mobile-menu-container .navbar-nav > li.menu-item-has-children .icon-toggle," +
          ".responsive .mobile-menu-container .navbar-nav > li.tc-menu-layout-builder .icon-toggle "
      ).on("click", function () {
      ...
      if ($(window).width() > 1024) {
          ...
          $magicLine
            ...
            .css(
              ...
              $current.position().left +
                parseInt($current_a.css("padding-left"))
            )
            .data(
              "origLeft",
              $current.position().left +
        ...
        $(".main-menu > .menu-item").hover(
          function () {
            ...
            leftPos =
              $el.position().left +
              parseInt($el.find("> a").css("padding-left"));
     ...
     */
    thim_topbar: function () {
      var header = $("#masthead"),
        height_header = header.outerHeight(true),
        content_pusher = $("#wrapper-container"),
        top_site_main = $("#wrapper-container .page-title .main-top");
      ...
      if (header.hasClass("header-overlay")) {
        ...
        content_pusher.css({ "padding-top": height_header + "px" });
        $(window).resize(function () {
          // var height_header = header.outerHeight(true);
          content_pusher.css({ "padding-top": height_header + "px" });
        });
    ...
    header_menu: function () {
      var $header = $("#masthead"),
        $header_wrapper = $("#masthead .header-wrapper"),
        off_Top = 0,
      ...
      $(
        "#masthead.template-layout-2 .main-menu > .menu-item-has-children, #masthead.template-layout-2 .main-menu > .tc-menu-layout-builder, .template-layout-2 .main-menu > li ul li"
      ).hover(
        function () {
      ...
      $(
        "#masthead.template-layout-2 .main-menu > .tc-menu-layout-builder"
      ).each(function () {
        var elem = $(this),
      ...
      $(".main-menu >li.tc-menu-layout-builder").each(function () {
        $(".widget_nav_menu ul.menu >li.current-menu-item")
          .parents("li.tc-menu-layout-builder")
    ...
    off_canvas_menu: function () {
      ...
      var widgetH = $off_canvas_menu
        .find(".off-canvas-widgetarea")
        .outerHeight();
    ...
    add_loading_enroll_button: function () {
      $(
        "body.no-single-popup  button.lp-button, body.logged-in form button.lp-button"
      ).on("click", function () {
    ...
    profile_update: function () {
      ...
      if ($form.hasClass("learnpress-v3-profile")) {
        $form.on("submit", function () {
          ...
          $sections.each(function () {
            ...
            if (slug === "avatar") {
              if (
                $section
                  .find('input[name="lp-user-avatar-custom"]')
                  .last()
                  .val() !== "yes"
              ) {
                compvared++;
        ...
        $form.on("submit", function () {
          ...
          $form.find("#submit .sk-three-bounce").removeClass("hidden");
          $els.each(function () {
            data["lp-profile-section"] = $(this)
              .find('input[name="lp-profile-section"]')
              .val();
            if (data["lp-profile-section"] === "avatar") {
              if (
                $(this)
                  .find('input[name="update-custom-avatar"]')
                  .last()
                  .val() !== "yes"
              ) {
                compvared++;
    ...
    get_tab_content: function (slug, current_tab) {
      ...
      $(".lp-profile .tabs-title .tab[data-tab=" + current_tab + "]").addClass(
        "active"
      );
    ...
    profile_slide_certificates: function () {
      ...
      $(
        "#tab-settings .certificates-section .learn-press-user-profile-certs"
      ).owlCarousel({
        rtl: rtlval,
        items: 4,
        nav: true,
      ...
      $(
        "#tab-settings .certificates-section .learn-press-user-profile-certs .more-info"
      ).on("click", function (e) {
        e.preventDefault();
        var url = $(this).parent().attr("href");
        history.pushState(null, null, url);
        thim_course_builder.get_tab_content(
          "#tab-certificates",
          "certificates_tab"
        );
      });
    ...
    coming_soon_hover_effect: function () {
      $(".thim-course-coming-soon .hover").mouseleave(function () {
    ...
    login_popup_ajax: function () {
      ...
      $(document).on(
        "click touch",
        "body.auto-login .thim-login-popup.thim-link-login a, body.dis-auto-login .thim-login-popup.thim-link-login a",
        function (event) {
          //// if ($(window).width() > 767) {
          event.preventDefault();
      ...
      $(document).on(
        "click touch",
        "body.dis-auto-login .thim-login-popup.thim-link-login a",
        function (event) {
          // if ($(window).width() > 767) {
      ...
      $(document).on("click touch", "#thim-popup-login", function (e) {
      ...
      $(document).on(
        "click touch",
        "body.auto-login #thim-popup-login .link-to-form a",
        function (event) {
          event.preventDefault();
      ...
      $(document).on(
        "click touch",
        "body.dis-auto-login #thim-popup-login .link-to-form a.login-link",
        function (event) {
          event.preventDefault();
      ...
      $("#popupLoginForm").submit(function (event) {
        ...
        if (!thim_course_builder.validate_popup_form($(this))) {
          return false;
        }
    ...
    form_submission_validate: function () {
      // Form login
      $(".form-submission-login form[name=loginform]").on(
        "submit",
        function (e) {
          if (!thim_course_builder.validate_popup_form($(this))) {
            e.preventDefault();
      ...
      // Form register
      $(".form-submission-register form[name=registerform]").on(
        "submit",
        function (e) {
          if (!thim_course_builder.validate_popup_form($(this))) {
            e.preventDefault();
      ...
      // Form lost password
      $(".form-submission-lost-password form[name=lostpasswordform]").on(
        "submit",
        function (e) {
          if (!thim_course_builder.validate_popup_form($(this))) {
            e.preventDefault();
        ...
        $.post(ajaxurl, contents, function (data) {
          ...
          for (status in response) {
            if (status === "password_reset") {
              ...
              content +=
                "<p class='alert alert-danger'>" + response[status][0] + "</p>";
            }
          }
          message.html(content);
        });
    ...
    validate_popup_form: function (form) {
      var valid = true,
      ...
      form.find("input.required").each(function () {
        ...
        if ($(this).hasClass("captcha-result")) {
          var captcha_1 = parseInt($(this).data("captcha1")),
    ...
    miniCartHover: function () {
      jQuery(document)
        .on("mouseenter", ".minicart_hover", function () {
    ...
    thim_course_filter: function () {
      ...
      var ajaxCall = function (data) {
        return $.ajax({
          ...
          .fail(function () {
            $(".archive-courses").removeClass("loading");
          })
          .done(function (data) {
            var $document = $($.parseHTML(data));
            $(".archive-courses").replaceWith(
              $document.find(".archive-courses")
            );
            $(".learn-press-pagination ul.page-numbers").replaceWith(
              $document.find(".learn-press-pagination ul.page-numbers")
            );
            $(".thim-course-top .course-index span").replaceWith(
              $document.find(".thim-course-top .course-index span")
            );
          });
      };
      ...
      $(document).on(
        "click",
        "#lp-archive-courses > .learn-press-pagination a.page-numbers",
        function (e) {
          e.preventDefault();
