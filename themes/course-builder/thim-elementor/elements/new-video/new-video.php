...
class Thim_New_Video_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-sc-new-video-box', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/video-box-custom.js', array( 'jquery', 'magnific-popup' ), '', true );
