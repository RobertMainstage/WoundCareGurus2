...
class Thim_Photo_Wall_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-sc-photo-wall', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/photo-wall.js', array( 'jquery','imagesloaded','masonry','waypoints' ), '', true );
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Photo_Wall_Element() );