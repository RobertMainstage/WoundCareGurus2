...
class Thim_Courses_Collection_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-courses-collection', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/courses-collection-custom.js', array(
			'jquery',
			'sly',
			'owlcarousel'
		), '', true );
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'default'          => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/sc-courses-collection-default.png' . '">',
						'icon'  => 'bp_el_class'
					],
					'rounded-corner'   => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/sc-courses-collection-rounded.png' . '">',
						'icon'  => 'bp_el_class'
					],
					'squared-corner'   => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/sc-courses-collection-squared.png' . '">',
						'icon'  => 'bp_el_class'
					],
					'squared-corner-2' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/sc-courses-collection-squared-2.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'rounded-kit'      => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/sc-courses-collection-rounded.png' . '">',
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Courses_Collection_Element() );