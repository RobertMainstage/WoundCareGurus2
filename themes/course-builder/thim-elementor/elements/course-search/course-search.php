...
class Thim_Course_Search_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-course-search', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/course-search.js', array( 'jquery' ), THIM_THEME_VERSION, true );
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Course_Search_Element() );