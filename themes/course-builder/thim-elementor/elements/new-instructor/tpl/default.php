...
$column  = 'col-md-6';
$columns = empty( $setting["columns"] ) ? '2' : $setting["columns"];
$column  = 'col-md-' . ( 12 / $columns );

$limit  = empty( $setting["limit"] ) ? '4' : $setting["limit"];
$offset = $setting['rank'];
...
<div class="thim-new-instructors <?php echo esc_attr( $setting['el_class'] ); ?>">
