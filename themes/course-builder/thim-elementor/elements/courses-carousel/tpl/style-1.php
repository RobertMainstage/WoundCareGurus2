...
<div class="thim-sc-courses-carousel style-1 <?php echo esc_attr( $setting['el_class'] ); ?>">
				...
				<div class="content">
					...
					<div class="hover-content">
						...
						<div class="description">
							<a href="<?php the_permalink(); ?>"><?php echo get_the_excerpt(); ?></a></div>
