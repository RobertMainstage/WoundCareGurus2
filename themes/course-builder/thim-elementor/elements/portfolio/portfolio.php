...
class Thim_Portfolio_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-portfolio-appear', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/jquery.appear.js', array( 'jquery' ), '', true );
		wp_enqueue_script( 'thim-portfolio-widget', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/portfolio.js', array(
			'jquery',
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Portfolio_Element() );