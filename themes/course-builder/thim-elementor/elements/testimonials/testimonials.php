...
class Thim_Testimonials_Element extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'thim-sc-testimonials', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/testimonials.js', array( 'jquery', 'thim-content-slider', 'owlcarousel' ), '', true );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'layout-1' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/layout-1.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'layout-2' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/layout-2.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'layout-3' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/layout-3.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'layout-4' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/layout-4.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'layout-5' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/layout-5.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'layout-6' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/layout-6.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'layout-7' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/layout-6.jpg' . '">',
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Testimonials_Element() );