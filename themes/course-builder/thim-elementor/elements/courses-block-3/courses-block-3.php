...
class Thim_Courses_Block_3_Element extends Widget_Base {
	...
	protected function _register_controls() {
 		...
 		wp_register_script( 'thim-courses-block-3', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/courses-block-3-custom.js', array( 'jquery','imagesloaded', 'isotope' ), '', true );
