...
class Thim_Video_Box_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-sc-video-box', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/video-box-custom.js', array( 'jquery', 'magnific-popup' ), '', true );
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'layout-1' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/layout1.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'layout-2' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/layout2.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
					'layout-3' => [
						'title' => '<img src="' . THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/images/layouts/layout3.jpg' . '">',
						'icon'  => 'bp_el_class'
					],
				],
				'default' => 'layout-1',
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Video_Box_Element() );