...
class Thim_Courses_Block_4_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-courses-block-4', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/course-block-4-custom.js', array( 'jquery' ), '', true );
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Courses_Block_4_Element() );