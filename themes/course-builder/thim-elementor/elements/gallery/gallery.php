...
class Thim_Gallery_Element extends Widget_Base {
	...
	protected function _register_controls() {
		...
		wp_register_script( 'thim-gallery', THIM_URI . 'thim-elementor/elements/' . $this->get_base() . '/assets/js/gallery-custom.js', array(
			'jquery',
			'isotope',
			'magnific-popup'
		), '', true );
...
Plugin::instance()->widgets_manager->register_widget_type( new Thim_Gallery_Element() );