		...
		public function process_payment( $order ) {
			...
			if ( ! empty( $stripe->error->message ) ) {
				...
				if ( ! empty( $pi ) ) {
					...
					//	learn_press_add_notice( $confim->error->message, 'error' );
					//	$result = array(
					//		'result' => 'fail',
					//	);
					//} else {
		...
		public function get_form_data() {
			if ( $this->order ) {
				...
				$this->form_data = array(
					...
					'customer_email'       => ! empty( $this->order->get_user( 'email' ) ) ? $this->order->get_user( 'email' ) : '',
